...
public class ImportDataActivity extends AppCompatActivity {
    ...
    Button btnImportOnlineData,btnImportStorageData;
    TextView tvORDivider;
    Context context=this;
    DatabaseAccess db;
    SystemInfo systemInfo=new SystemInfo();
    private ProgressDialog progressDialog;
    private String TAG = ImportDataActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnImportOnlineData.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnImportStorageData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void setLayoutResource(){
        btnImportOnlineData=findViewById(R.id.btnImportOnlineData);
        btnImportStorageData=findViewById(R.id.btnImportStorageData);
        tvORDivider=findViewById(R.id.tvORDivider);

        if(systemInfo.EndUserType==systemInfo.DirectCustomer) {
            btnImportStorageData.setVisibility(View.VISIBLE);
            tvORDivider.setVisibility(View.VISIBLE);
        }
