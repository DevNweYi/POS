...
public class PurchaseTranAdapter extends BaseAdapter {
    private Context context;
    List<TranPurchaseModel> lstTranPurchase;
    SystemInfo systemInfo=new SystemInfo();

    public PurchaseTranAdapter(Context context, List<TranPurchaseModel> lstTranPurchase){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvAmount.setText(String.valueOf(systemInfo.df.format(lstTranPurchase.get(position).getAmount())));
